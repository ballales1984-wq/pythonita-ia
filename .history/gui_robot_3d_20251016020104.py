...
class PythonitaGUI3D:
    ...
    def _on_key_release(self, event=None):
        """Handler rilascio tasto (debouncing)."""
        if self.after_id:
            self.root.after_cancel(self.after_id)
        self.after_id = self.root.after(500, self._aggiorna_codice)
...
║                                                                  ║
║   Scrivi comando in italiano → Vedi animazione 3D reale!         ║
║                                                                  ║
╚══════════════════════════════════════════════════════════════════╝
...
La GUI e' aperta! Prova a scrivere un comando...
""")
